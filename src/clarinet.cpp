...
clarinet::clarinet(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void clarinet::setParamValue(const string& path, float value)
{
    fUI->setParamValue(path, value);
}

float clarinet::getParamValue(const string& path)
{
...
extern "C" void app_main()
{
    ...
    clarinet* DSP = new clarinet(48000, 32);
    DSP->start();
